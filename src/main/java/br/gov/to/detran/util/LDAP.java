...
public class LDAP {
    ...
    private static String[] userAttributes = {
        ...
        "userPrincipalName", "userAccountControl", "displayName",        
    };
   ...
   */
    public static class User {
        ...
        public User(Attributes attr) throws javax.naming.NamingException {
            ...
            userAccountControl = (String) attr.get("userAccountControl").get();
            displayName = (String) attr.get("displayName").get();
        }

        public User(String distinguishedName, String userPrincipal, String commonName, String userAccountControl, String displayName) {
